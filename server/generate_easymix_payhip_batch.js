...
async function generateEasyMixPayhipBatch() {
    const count = parseInt(process.argv[2] || '11', 10);
    const maxDevices = parseInt(process.argv[3] || '3', 10); // 3 devices per lifetime key

    console.log(`\n🔑 Generando ${count} licencias LIFETIME para Easy Mix en Supabase...\n`);
    ...
    console.log(`=======================================================`);
    console.log(`COPIA Y PEGA ESTAS ${generatedKeys.length} CLAVES PARA EASY MIX EN PAYHIP:`);
    console.log(`=======================================================\n`);
    generatedKeys.forEach(key => console.log(key));
    console.log(`\n=======================================================\n`);
}

generateEasyMixPayhipBatch();
