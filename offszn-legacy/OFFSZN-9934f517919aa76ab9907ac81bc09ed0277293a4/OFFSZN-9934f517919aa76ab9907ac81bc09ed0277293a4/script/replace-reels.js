...
for (const file of htmlFiles) {
    ...
    const replacement = `<a href="/studio/genera-sonidos.html" class="dropdown-item" style="border-radius: 8px;">
    ...
    const mobileReplacement = `<a href="/studio/genera-sonidos.html" class="mobile-menu-link sub"><i class="bi bi-music-note-beamed"></i> GENERADOR IA</a>`;
